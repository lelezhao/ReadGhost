...
namespace ReadGhost.ServiceReference {
    ...
    public partial class GetTranslationsResponse : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private ReadGhost.ServiceReference.TranslationMatch[] TranslationsField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute(EmitDefaultValue=false)]
        public ReadGhost.ServiceReference.TranslationMatch[] Translations {
            get {
    ...
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://api.microsofttranslator.com/V2", ConfigurationName="ServiceReference.LanguageService")]
    public interface LanguageService {
        ...
        ReadGhost.ServiceReference.GetTranslationsResponse GetTranslations(string appId, string text, string from, string to, int maxTranslations, ReadGhost.ServiceReference.TranslateOptions options);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://api.microsofttranslator.com/V2/LanguageService/AddTranslationArray", ReplyAction="http://api.microsofttranslator.com/V2/LanguageService/AddTranslationArrayResponse" +
            "")]
        void AddTranslationArray(string appId, ReadGhost.ServiceReference.Translation[] translations, string from, string to, ReadGhost.ServiceReference.TranslateOptions options);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://api.microsofttranslator.com/V2/LanguageService/GetTranslationsArray", ReplyAction="http://api.microsofttranslator.com/V2/LanguageService/GetTranslationsArrayRespons" +
            "e")]
        ReadGhost.ServiceReference.GetTranslationsResponse[] GetTranslationsArray(string appId, string[] texts, string from, string to, int maxTranslations, ReadGhost.ServiceReference.TranslateOptions options);
        ...
        ReadGhost.ServiceReference.TranslateArrayResponse[] TranslateArray(string appId, string[] texts, string from, string to, ReadGhost.ServiceReference.TranslateOptions options);
        ...
        ReadGhost.ServiceReference.TranslateArray2Response[] TranslateArray2(string appId, string[] texts, string from, string to, ReadGhost.ServiceReference.TranslateOptions options);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface LanguageServiceChannel : ReadGhost.ServiceReference.LanguageService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class LanguageServiceClient : System.ServiceModel.ClientBase<ReadGhost.ServiceReference.LanguageService>, ReadGhost.ServiceReference.LanguageService {
        ...
        public ReadGhost.ServiceReference.GetTranslationsResponse GetTranslations(string appId, string text, string from, string to, int maxTranslations, ReadGhost.ServiceReference.TranslateOptions options) {
        ...
        public void AddTranslationArray(string appId, ReadGhost.ServiceReference.Translation[] translations, string from, string to, ReadGhost.ServiceReference.TranslateOptions options) {
            base.Channel.AddTranslationArray(appId, translations, from, to, options);
        }
        
        public ReadGhost.ServiceReference.GetTranslationsResponse[] GetTranslationsArray(string appId, string[] texts, string from, string to, int maxTranslations, ReadGhost.ServiceReference.TranslateOptions options) {
        ...
        public ReadGhost.ServiceReference.TranslateArrayResponse[] TranslateArray(string appId, string[] texts, string from, string to, ReadGhost.ServiceReference.TranslateOptions options) {
            return base.Channel.TranslateArray(appId, texts, from, to, options);
        }
        
        public ReadGhost.ServiceReference.TranslateArray2Response[] TranslateArray2(string appId, string[] texts, string from, string to, ReadGhost.ServiceReference.TranslateOptions options) {
